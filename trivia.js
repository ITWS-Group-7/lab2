$(document).ready(function() {
    var Allquestions = [
     ...
     createQuiz(allQuestions, quizs, results, submits);
    function createQuiz(questions, quizs,results, submits){
       
        function showQuiz(questions,quizs){
            var output =[];
            var answers;
        ...
        function showScore(questions, quizs, results){
            var allAnswers = quizs.querySelectorAll('.answers');
        ...
        showQuiz(questions,quizs);
    
        submits.onclick = function(){
            showScore(questions, quizs, results);
        }
